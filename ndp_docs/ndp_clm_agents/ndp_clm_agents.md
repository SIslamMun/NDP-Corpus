...
### enhanced_clm_agent.ipynb (55,700 bytes)
...
### simple_clm_agent.ipynb (20,974 bytes)
...
## Step 0: Ensure JupyterLab Widget Rendering is Enabled
...
!pip -q install python-dotenv ipywidgets pydantic-ai fastmcp openai nest-asyncio --no-warn-script-location
```
...
### simple_clm_agent_with_logfire.ipynb (17,325 bytes)

# simple_clm_agent_with_logfire
...
```python
!pip -q install python-dotenv ipywidgets pydantic-ai fastmcp openai nest-asyncio logfire opentelemetry-instrumentation-openai opentelemetry-instrumentation-httpx --no-warn-script-location
```
...
print("✓ Everything initialized with cloud-only logging")
print("✓ OpenAI API calls will be logged to Logfire cloud")
print("✓ HTTP requests (MCP) will be logged to Logfire cloud")
print("✓ No local logs created")
